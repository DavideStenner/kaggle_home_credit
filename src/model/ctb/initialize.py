...
class CTBInit(ModelInit):
    def __init__(self, 
        ...
        self.params_ctb: dict[str, Any] = params_ctb
        
        self.model_list: list[cb.CatBoost] = []
        self.model_list_stability: list[cb.CatBoost] = []
    ...
    def save_params(self) -> None:
        with open(
            ...
            json.dump(self.params_ctb, file)
    ...
    def load_params(self) -> None:
        with open(
            ...
            self.params_ctb = json.load(file)
    ...
    def save_custom_pickle_model_list(self, model_list: list[cb.CatBoost], file_name: str) -> None:
        with open(
            os.path.join(
                self.experiment_path,
                file_name
    ...
    def load_custom_pickle_model_list(self, file_name: str) -> list[cb.CatBoost]:
        with open(
            os.path.join(
                self.experiment_path,
                file_name
